...
@Named
@ViewScoped
public class BookSortingBean implements Serializable {
    ...
    private static final String RATING_SORT_OPTION_KEY = "rating";


    private SortOrder createdDefaultSortOrder = SortOrder.descending;
    private SortOrder ratingDefaultSortOrder = SortOrder.descending;
    ...
    public void initSortOrders() {
        ...
        this.sortPriorities.add(RATING_SORT_OPTION_KEY);
        this.sortsOrders.put(CREATED_SORT_OPTION_KEY, createdDefaultSortOrder);
        this.sortsOrders.put(RATING_SORT_OPTION_KEY, ratingDefaultSortOrder);
    }
